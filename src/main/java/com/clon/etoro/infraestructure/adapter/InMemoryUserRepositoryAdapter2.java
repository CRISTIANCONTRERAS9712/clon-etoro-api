...
public class InMemoryUserRepositoryAdapter2 implements UserRepository {
	
	//private final Map<Long, User> db = new HashMap<>();
	private final List<User> users = new ArrayList<>();
	
    public InMemoryUserRepositoryAdapter2() {
...
//        db.put(3L, new User(3L, "Juan", "Pinto", "3@gmail.com", LocalDate.now(), "12345", "3549878787"));
    	...
    	users.add(new User(4L, "Cristian", "Contreras", "1@gmail.com", LocalDate.now(), "12345", "3549878787", country));
    	users.add(new User(5L, "Pedro", "Perez", "2@gmail.com", LocalDate.now(), "12345", "3549878787", country));
    	users.add(new User(6L, "Juan", "Pinto", "3@gmail.com", LocalDate.now(), "12345", "3549878787", country));
    }
