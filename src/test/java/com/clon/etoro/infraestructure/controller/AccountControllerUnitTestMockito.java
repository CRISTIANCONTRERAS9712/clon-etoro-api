...
public class AccountControllerUnitTestMockito {
        ...
        void testCreateAccount_ShouldReturnCreatedAccount() {
                ...
                Mockito.when(createAccountUseCase.execute(Mockito.any(CreateAccountRequest.class)))
        ...
        void testUpdateAccount_ShouldReturnUpdatedAccount() {
                ...
                updatedAccount.setCashAvailable(Double.valueOf("2000.00").doubleValue());
                updatedAccount.setUser(defaultUser);

                Mockito.when(updateAccountUseCase.execute(Mockito.any(UpdateAccountRequest.class)))
